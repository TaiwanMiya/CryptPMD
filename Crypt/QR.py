...
from Crypt.Png import *
from Crypt.Canvas import Name
from Crypt.CryptoApi import CryptoCanvas
import io
import itertools
import math
modes = {
...
class QRCode:
    ...
    def terminal(self, module_color='black', background='white',quiet_zone=4):
...
def _terminal(code, module_color='black', back_color='white', quiet_zone=4):
    buf = io.StringIO()
